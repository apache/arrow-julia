...
# GENERATED by core/tools/fbsgen.jl from apache/arrow format/Schema.fbs —
# do not edit by hand; rerun the generator against the current spec.

@enumx MetadataVersion::Int16 V1=0 V2=1 V3=2 V4=3 V5=4

@enumx Feature::Int64 UNUSED=0 DICTIONARY_REPLACEMENT=1 COMPRESSED_BODY=2
...
mapAddKeysSorted(b::FlatBuffers.Builder, keysSorted::Base.Bool) =
    FlatBuffers.prependslot!(b, 0, keysSorted, false)
mapEnd(b::FlatBuffers.Builder) = FlatBuffers.endobject!(b)

@enumx UnionMode::Int16 Sparse=0 Dense=1
...
intAddIsSigned(b::FlatBuffers.Builder, is_signed::Base.Bool) =
    FlatBuffers.prependslot!(b, 1, is_signed, false)
intEnd(b::FlatBuffers.Builder) = FlatBuffers.endobject!(b)

@enumx Precision::Int16 HALF=0 SINGLE=1 DOUBLE=2
...
largeUtf8Start(b::FlatBuffers.Builder) = FlatBuffers.startobject!(b, 0)
largeUtf8End(b::FlatBuffers.Builder) = FlatBuffers.endobject!(b)
...
decimalAddBitWidth(b::FlatBuffers.Builder, bitWidth::Int32) =
    FlatBuffers.prependslot!(b, 2, bitWidth, 128)
decimalEnd(b::FlatBuffers.Builder) = FlatBuffers.endobject!(b)

@enumx DateUnit::Int16 DAY=0 MILLISECOND=1
...
@enumx TimeUnit::Int16 SECOND=0 MILLISECOND=1 MICROSECOND=2 NANOSECOND=3
...
@enumx IntervalUnit::Int16 YEAR_MONTH=0 DAY_TIME=1 MONTH_DAY_NANO=2
...
@enumx DictionaryKind::Int16 DenseArray=0
...
function Base.getproperty(x::DictionaryEncoding, field::Symbol)
    ...
    elseif field === :dictionaryKind
        ...
        return DictionaryKind.DenseArray
    end
    return nothing
end

dictionaryEncodingStart(b::FlatBuffers.Builder) = FlatBuffers.startobject!(b, 4)
...
fieldStartChildrenVector(b::FlatBuffers.Builder, numelems) =
    FlatBuffers.startvector!(b, 4, numelems, 4)
fieldAddCustomMetadata(b::FlatBuffers.Builder, custom_metadata::FlatBuffers.UOffsetT) =
    FlatBuffers.prependoffsetslot!(b, 6, custom_metadata, 0)
fieldStartCustomMetadataVector(b::FlatBuffers.Builder, numelems) =
    FlatBuffers.startvector!(b, 4, numelems, 4)
fieldEnd(b::FlatBuffers.Builder) = FlatBuffers.endobject!(b)

@enumx Endianness::Int16 Little=0 Big=1
...
Base.propertynames(x::Schema) = (:endianness, :fields, :custom_metadata, :features)
...
function Base.getproperty(x::Schema, field::Symbol)
    ...
    elseif field === :features
        o = FlatBuffers.offset(x, 10)
        if o != 0
            return FlatBuffers.Array{Feature.T}(x, o)
        end
    end
    return nothing
end

schemaStart(b::FlatBuffers.Builder) = FlatBuffers.startobject!(b, 4)
...
schemaStartFieldsVector(b::FlatBuffers.Builder, numelems) =
    FlatBuffers.startvector!(b, 4, numelems, 4)
schemaAddCustomMetadata(b::FlatBuffers.Builder, custom_metadata::FlatBuffers.UOffsetT) =
    FlatBuffers.prependoffsetslot!(b, 2, custom_metadata, 0)
schemaStartCustomMetadataVector(b::FlatBuffers.Builder, numelems) =
    FlatBuffers.startvector!(b, 4, numelems, 4)
schemaAddFeatures(b::FlatBuffers.Builder, features::FlatBuffers.UOffsetT) =
    FlatBuffers.prependoffsetslot!(b, 3, features, 0)
