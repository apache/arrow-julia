...
# GENERATED by core/tools/fbsgen.jl from apache/arrow format/Message.fbs —
...
function createFieldNode(b::FlatBuffers.Builder, length::Int64, null_count::Int64)
    FlatBuffers.prep!(b, 8, 16)
    prepend!(b, null_count)
    prepend!(b, length)
    return FlatBuffers.offset(b)
end

@enumx CompressionType::Int8 LZ4_FRAME=0 ZSTD=1

@enumx BodyCompressionMethod::Int8 BUFFER=0
...
messageAddCustomMetadata(b::FlatBuffers.Builder, custom_metadata::FlatBuffers.UOffsetT) =
