...
| `REVIEW-codex-r1.md`, `REVIEW-codex-r2.md`, `REVIEW-codex-r3.md`, `REVIEW-codex-r4.md`, `REVIEW-codex-r5.md` | Adversarial review findings and the disposition of each item |
