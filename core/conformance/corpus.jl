...
#
#     julia --project=core/conformance core/conformance/corpus.jl [corpus-dir]
#
...
using Arrow  # 2.x, for its FlatBuffers runtime + fixtures the examples need
include(joinpath(@__DIR__, "..", "examples", "ipc_write.jl"))   # brings ipc_read + Core
