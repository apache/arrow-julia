...
# bijection with storage — so every operator survives lowering at every
# unit. (Date64 stays equality-only above: its `DateTime` epoch shift wraps
# at the Int64 edges.)
_scancomparisonpreserving(::AC.TimestampType, op) = true
